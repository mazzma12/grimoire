...
This is to present the trip of the boat Carlina part of the Realize'exploration.
You can add the description you like...
...
```{python}
locations_gdf = gdf.groupby("name", sort=False).last()
